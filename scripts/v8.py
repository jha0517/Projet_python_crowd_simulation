...
def controllerFoot():
    ...
    # tip toe controller
#    CreateCtr('FootTip_L_Crl','Foot_L_heelPeel',Xpos,Ypos*30,Zpos,3,3,3,0,90,-90)
    cmds.CreateNURBSCircle()
...
#left Arm
    ...
    #left Arm controller
    CreateCtr('Arm_L_Crl','Arm_L_ikHandle',(locXYZ[3][0],locXYZ[3][1],locXYZ[3][2]),(5,5,8),(0,0,30))
...
#    cmds.move(pivotX,pivotY,pivotZ, nameCtr+'.scalePivot',nameCtr+'.rotatePivot', absolute=True)
    cmds.makeIdentity(apply=True)
...
cmds.select(d=True)
cmds.joint(p=(locXYZ[0][0],locXYZ[0][1],locXYZ[0][2]),n = charName + '_root'+'_Jnt_01')
cmds.parent('men_L_hip_Jnt_01')
cmds.select(charName + '_root'+'_Jnt_01')
cmds.parent('men_R_hip_Jnt_01')
...
cmds.parentConstraint(charName+'_Chest_Ctrl_01','men_L_shoulder_Jnt_01', maintainOffset=True)
cmds.parentConstraint(charName+'_Chest_Ctrl_01','men_R_shoulder_Jnt_01', maintainOffset=True)
cmds.parent('Arm_L_Crl_grp',charName+'_Chest_Ctrl_01')
cmds.parent('Elbow_L_Crl',charName+'_Chest_Ctrl_01')
